...
QTPATH=/Users/iori/Qt5.2.1/5.2.1/clang_64/
...
#scripts/macdeployhelper510.sh ${APPNAME}Contents/MacOS/KanmusuMemory
#find KanmusuMemory.app -name "*.dylib" | xargs -n1 scripts/macdeployhelper510.sh
#find KanmusuMemory.app/Contents/Frameworks -name "Qt*" -type f | xargs -n1 scripts/macdeployhelper510.sh
